...
<table width="100%" cellpadding="10" class="form-table">
  ...
  <tr valign="top">
  	<td width="200" align="right">
	 <input type="radio" name="size" id="radio" value="feature-email" <?php if ($image_size == 'feature-email') echo "checked=\"checked\"";?>/>
     </td> 
  	<td align="left" scope="row"><?php _e("Featured Email Size (600x300) - Custom from Theme.") ?></td>
  </tr>
</table>
