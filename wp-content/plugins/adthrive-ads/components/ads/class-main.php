...
class Main {
	...
	public function setup() {
		...
		add_action( 'wp_head', array( $this, 'ad_head' ) );
	...
	public function ad_head() {
		...
		if ( isset( $data['site_id'] ) && preg_match( '/[0-9a-f]{24}/i', $data['site_id'] ) ) {
	...
	public function get_term_selectize( $taxonomy = 'category', $args = array() ) {
		...
		$args = wp_parse_args( $args, array( 'taxonomy' => 'category', 'number' => 100 ) );
