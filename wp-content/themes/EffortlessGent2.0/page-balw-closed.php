<?php
/*
Template Name: BALW Course Closed
*/
?>
...
<?php get_header( 'focused' ) ?>
		    ...
		    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div id="copyright" class="row">
					<div class="large-3 medium-4 small-7 large-centered medium-centered small-centered columns">
						<img data-interchange="[/wp-content/themes/EffortlessGent/library/images/logo-navcolor-tag.png, (only screen and (min-width: 1px))], [/wp-content/themes/EffortlessGent/library/images/logo-navcolor-tag.png, (only screen and (-webkit-min-device-pixel-ratio: 2))]">
					</div>
				</div>
