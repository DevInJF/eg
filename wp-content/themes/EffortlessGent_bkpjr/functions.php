...
function joints_register_sidebars() {
	...
	register_sidebar(array(
		'id' => 'handpicked',
		'name' => __('Hand-Picked Articles', 'jointstheme'),
		'description' => __('Home - Hand-Picked Articles', 'jointstheme'),
		'before_widget' => '<div id="%1$s" class="handpicked widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
	));
	...
	register_sidebar(array(
		'id' => 'bigboxad',
		'name' => __('Big Box Ad', 'jointstheme'),
		'description' => __('Home - Big Box Ad', 'jointstheme'),
		'before_widget' => '<div id="%1$s" class="big-box-ad widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
	));
	...
	register_sidebar(array(
		'id' => 'smalltileadleft',
		'name' => __('Small Tile Ad left', 'jointstheme'),
		'description' => __('Home - Small Tile Ad, left', 'jointstheme'),
		'before_widget' => '<div id="%1$s" class="small-tile-ad-left widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
	));
	...
	register_sidebar(array(
		'id' => 'smalltileadright',
		'name' => __('Small Tile Ad Right', 'jointstheme'),
		'description' => __('Home - Small Tile Ad, left', 'jointstheme'),
		'before_widget' => '<div id="%1$s" class="small-tile-ad-right widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
	));
	...
	register_sidebar(array(
		'id' => 'singlepost',
		'name' => __('Single Post', 'jointstheme'),
		'description' => __('Sidebar for Single Post Pages.', 'jointstheme'),
		'before_widget' => '<div id="%1$s" class="singlepostsidebar widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
	));
...
//adding blog page feature post large size
add_image_size( 'blog-feature-post-image', 9999, 460 ); // Permalink thumbnail size
